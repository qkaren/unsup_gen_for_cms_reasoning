...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="", help="dir")
    parser.add_argument(
    ...
    forward_output = './{}/abd_output_len_{}_sts_{}_mr_{}_np_{}_ni_{}_tfst_{}_tbd_{}_tfd_{}.json'.format(args.output_dir, args.length, \
        args.stepsize, args.mix_rate, args.num_passes, args.num_iterations, args.temperature_first, args.temperature_backward, args.temperature_forward)
    ...
    with open(forward_output, 'w') as fw:
        for r in records:
            o1_text = '<|endoftext|>'.join([r['obs2'], r['obs1']])
            o2_text = r['obs2']
            if o1_text not in rm_dup:
